...
void ImprimirAyuda(void)
{
	...
	printf("\t\t\t[--pssbf][--wbf][--mbf][--alpha factor]\n");
	printf("\n");
	printf("\t-v\n");
	...
	printf("\t\tmatriz de paridad P, en el formato AList de Mackay.\n");
	printf("\t\thttp://www.inference.phy.cam.ac.uk/mackay/codes/alist.html\n");
	printf("\t\n");
	...
	printf("\t\n");
	printf("\t--ber-min BER_minimo\n");
	printf("\t\tBER_minimo es el valor mínimo que tomara cualquiera de los\n");
	...
	printf("\t\tpor defecto de Paquetes es: %ld \n",PACKMAXDEFAULT);
	printf("\t\n");
